...
public class Trivia3Activity extends AppCompatActivity {
    ...
    private void pre1() {
        pregunta.setText("3.-Se denomina así, a la propiedad que permite subdividir una aplicación en partes mas pequeñas, permitiendo independencia entre ellas." +
                "\nA)Modularidad" +
                "\nB)Abstracción" +
                "\nC)Polimorfismo");
    }
    ...
    private void Timer(){
        new Handler().postDelayed(new Runnable(){
            public void run(){
                ...
                Intent intent = new Intent(Trivia3Activity.this, Trivia4Activity.class);
