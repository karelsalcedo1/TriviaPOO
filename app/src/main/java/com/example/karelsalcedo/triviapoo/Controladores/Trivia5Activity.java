...
public class Trivia5Activity extends AppCompatActivity {
    TextView pregunta;
    ImageView Bien, Mal;
    ...
    private void pre1() {
        pregunta.setText("5.-Son funciones miembro especiales que sirven para eliminar un objeto de una determinada clase. Cuando se define para una clase, este es llamado automáticamente cuando se abandono el ámbito en el que fue definido." +
                "\nA)Constructor" +
                "\nB)Destructor" +
                "\nC)New");
    }
    ...
    private void Timer(){
        new Handler().postDelayed(new Runnable(){
            public void run(){
                ...
                Intent intent = new Intent(Trivia5Activity.this, Trivia6Activity.class);
